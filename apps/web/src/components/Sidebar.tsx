...
export default function Sidebar() {
  ...
  return (
    <aside className="w-full md:w-64 md:min-h-screen bg-surface-container-low border-b md:border-b-0 md:border-r border-outline-variant flex flex-col shrink-0">
